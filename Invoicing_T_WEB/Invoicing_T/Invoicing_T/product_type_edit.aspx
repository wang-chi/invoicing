<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_type_edit.aspx.cs" Inherits="Invoicing_T.product_type_edit" %>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="member_manage.aspx">編輯商品類別資料
