        ...
        <div class="row">
            ...
            <main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
                <form runat="server">
                    ...
                    <asp:Button ID="Button1" class="btn" runat="server" Text="新增" OnClick="btn_insert_group" />
                        ...
                        <asp:ListView ID="lvCampInfo" runat="server" GroupItemCount="1"
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="lbtUpDate" runat="server" class="btn btn-primary btn-sm" PostBackUrl='<%# "group_edit.aspx?ActionState=UpDate&r_id="+Eval("r_id")%>' ToolTip="修改">
                                            <asp:Label ID="Label7" runat="server" Text="修改"></asp:Label>
                                        </asp:LinkButton>
                                    </td>
                                    <td>
                                        <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-primary btn-sm" PostBackUrl='<%# "group_edit.aspx?ActionState=Delete&r_id="+Eval("r_id")%>' ToolTip="刪除">
