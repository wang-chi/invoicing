        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
                    ...
                    <div>
                        <form id="form1" runat="server">
                            ...
                            <div class="form-group">
                                公司ID：
                                <asp:Label ID="com_id" runat="server" Text='<%# Eval("com_id") %>' />
                            </div>
                            ...
                            <div>
                            公司地址：
                            <asp:TextBox ID="com_address" runat="server"></asp:TextBox>
                                </div>
                            <div>
                            公司統一編號：
                            <asp:TextBox ID="com_un" runat="server"></asp:TextBox>
                                </div>
                            <div>
                            公司負責人：
                            <asp:TextBox ID="com_agent" runat="server"></asp:TextBox>
                                </div>
                            <div>
                            公司電話：
                            <asp:TextBox ID="com_tel" runat="server"></asp:TextBox>
                                </div>
                            <div>
                            公司傳真號碼：
                            <asp:TextBox ID="com_fax" runat="server"></asp:TextBox>
                                </div>
                             <div>
                    ...
                    <div class="form-group">
                        <asp:Button ID="btUpDatecompany" class="btn" runat="server" Text="修　　改" OnClick="btUpDatecompany_Click" />
                    </div>
